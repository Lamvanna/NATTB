...
{ int n;
	...
	Sapxep(a,n);
	XuatsvN(a,n);
	printf("\n\n\n An phi bat ky de in DS Gioi_Xuat_sac ");
	getch();
	INGX(a,n);
	printf("\n\n\n An phi bat ky de tim SV ");
	getch();
	TIMSV(a,n);
}
void Nhapsv(SINHVIEN &x)
...
{
	printf("|%5s|%-18s|%-6s|%10d|%-aas|%12.1f|%-10s|%-10s|",x.Masv,x.Hotensv,x.Phai,x.Namsinh,x.Nganhhoc,x.Kqcuoikhoa,x.Xeploai,x.Quequan);
